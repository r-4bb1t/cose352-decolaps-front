...
// source: decolaps/decolaps/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_06b59d845a213876, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_06b59d845a213876, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "decolaps.decolaps.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "decolaps.decolaps.QueryParamsResponse")
}

func init() { proto.RegisterFile("decolaps/decolaps/query.proto", fileDescriptor_06b59d845a213876) }

var fileDescriptor_06b59d845a213876 = []byte{
	// 279 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0x4d, 0x49, 0x4d, 0xce,
	0xcf, 0x49, 0x2c, 0x28, 0xd6, 0x87, 0x33, 0x0a, 0x4b, 0x53, 0x8b, 0x2a, 0xf5, 0x0a, 0x8a, 0xf2,
	...
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0xe1, 0x64, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xb5,
	0x5c, 0xaa, 0x44, 0xdb, 0x01, 0x00, 0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/decolaps.decolaps.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/decolaps.decolaps.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "decolaps.decolaps.Query",
	...
	Metadata: "decolaps/decolaps/query.proto",
}
